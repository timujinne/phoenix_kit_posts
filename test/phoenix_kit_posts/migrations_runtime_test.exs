defmodule PhoenixKitPosts.MigrationsRuntimeTest do
  ...
  test "reads the version parsed out of the pkpo_schema marker" do
    Repo.query!("COMMENT ON TABLE #{@anchor} IS 'pkpo_schema:1'")
